...
- The [synthetic demo](synthetic-demo.md) now supplies reproducible local startup. Add portfolio screenshots and complete the public-release walkthrough; production-archive recovery remains in roadmap item 1.
