...
| [0004: Agent service boundary](decisions/0004-agent-service-boundary.md) | Accepted; catalog and registry implemented | Centralize provider access and tool registration |
