...
- [Database recovery](runbooks/database-recovery.md): proposed snapshot/import workflow and recovery evidence.
...
| [0003: Local parity and recovery](decisions/0003-local-parity-and-recovery.md) | Proposed | Use local rehearsal before adding another hosted environment |
| [0004: Agent service boundary](decisions/0004-agent-service-boundary.md) | Accepted direction; pending | Centralize provider access and tool registration |
