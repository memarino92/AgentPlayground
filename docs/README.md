...
- [Jev implementation proposal](plans/jev-integration.md): pre-chat tool routing, simulated home automation and evidence reranking, with evaluation gates and staged effort; not implemented.
...
| [0026: Structured decision provider](decisions/0026-structured-decision-provider.md) | Proposed; not implemented | Evaluate API-owned Jev tool routing, home automation and evidence reranking |
