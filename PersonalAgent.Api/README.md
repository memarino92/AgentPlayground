...
`PersonalAgent.Api` is the central API service for chat orchestration and model tasks in the PersonalAgent stack.
...
These consumers are registered with retry policies and respond with typed contracts from `PersonalAgent.Contracts`.
