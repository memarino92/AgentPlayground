...
Imported from dotnet/skills plugin 'dotnet-msbuild'. Upstream references to 'search' map to 'glob' and/or 'grep'; 'execute' maps to 'bash'; and agent orchestration should use the Task tool with imported subagents by name.
