...
| `PersonalAgent.Contracts` | Shared message contracts and cross-service infrastructure configuration |
| `PersonalAgent.Integrations` | Encrypted runtime settings, Sentry reporting, OpenTelemetry and OpenInference instrumentation |
...
```powershell
dotnet build PersonalAgent.Api/PersonalAgent.Api.csproj
...
```powershell
dotnet test PersonalAgent.Contracts.Tests/PersonalAgent.Contracts.Tests.csproj
...
- [API details](PersonalAgent.Api/README.md), [Web details](PersonalAgent.Web/README.md), and [contributor instructions](AGENTS.md).
